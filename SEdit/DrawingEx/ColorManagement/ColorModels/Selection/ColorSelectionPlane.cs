...
//			catch{}
		...
		public bool SetPosition(double posx, double posy)
		{
			...
			Invalidate(Rectangle.Inflate(GetCursorBounds(_x,_y),1,1));
			this.Update();
            Game.ActiveScene.SkyBoxColor = new(((ColorPicker)Parent).lblColorOut.OldColor.R, ((ColorPicker)Parent).lblColorOut.OldColor.G, ((ColorPicker)Parent).lblColorOut.OldColor.B, ((ColorPicker)Parent).lblColorOut.OldColor.A);
            return true;
		}
		#endregion
		#region properties
