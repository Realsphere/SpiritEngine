...
namespace Realsphere.Spirit.Internal
{
    ...
    internal struct Vertex
    {
        ...
        /// <param name="color"></param>
        public Vertex(float pX, float pY, float pZ, Vector3 normal, Color color)
        ...
        public Vertex(Vector3 position, Vector3 normal, Color color)
            : this(position, normal, color, Vector2.Zero, new Mesh.SkinningVertex(), Vector4.Zero)
        { }
        ...
        public Vertex(Vector3 position, Vector3 normal, Color color, Vector2 uv)
            : this(position, normal, color, uv, new Mesh.SkinningVertex(), Vector4.Zero)
        { }
        ...
        /// <param name="normal"></param>
        /// <param name="color"></param>
        public Vertex(Vector3 position, Vector3 normal, Color color, Vector2 uv, Mesh.SkinningVertex skin, Vector4 tangent)
        {
            Position = position;
            Normal = normal;
            Color = color;
