...
namespace Realsphere.Spirit.Mathematics
{
    ...
    {
        public static readonly SQuaternion Identity = new SQuaternion(0f, 0f, 0f, 0f);
        ...
        public static implicit operator System.Numerics.Quaternion(SQuaternion a)
        {
            return new(a.X, a.Y, a.Z, a.W);
        }

        public static implicit operator SQuaternion(System.Numerics.Quaternion a)
        {
            return new(a.X, a.Y, a.Z, a.W);
        }
