...
namespace Realsphere.Spirit.RenderingCommon
{
    ...
    internal abstract class D3DApplicationBase: Component
    {
        ...
        internal SharpDX.Direct3D11.Texture2D _backBuffer;
        internal SharpDX.Direct3D11.Texture2D _depthBuffer;
...
//        /// </summary>
//        internal Windows.Foundation.Rect Bounds { get; protected set; }

//        /// <summary>
//        /// Gets the bounds of the control linked to this render target
//        /// </summary>
//        internal abstract Windows.Foundation.Rect CurrentBounds { get; }
//#else
        /// <summary>
        /// Gets the configured bounds of the control used to render to
        /// </summary>
        internal SharpDX.Rectangle Bounds { get; set; }

        /// <summary>
        /// Gets the current bounds of the control used to render to
        /// </summary>
        internal abstract SharpDX.Rectangle CurrentBounds { get; }
//#endif
        /// <summary>
        /// Gets the <see cref="DeviceManager"/> attached to this instance.
        /// </summary>
        internal DeviceManager DeviceManager { get { return _deviceManager; } }
        ...
        /// </summary>
        internal ModeDescription[] DisplayModeList { get; set; }
        ...
        /// </summary>
        internal SharpDX.Direct3D11.RenderTargetView RenderTargetView
        {
        ...
        /// </summary>
        internal SharpDX.Direct3D11.Texture2D BackBuffer
        {
        ...
        /// </summary>
        internal SharpDX.Direct3D11.Texture2D DepthBuffer
        {
        ...
        /// </summary>
        internal SharpDX.Direct3D11.DepthStencilView DepthStencilView
        {
        ...
        /// </summary>
        internal SharpDX.Direct2D1.Bitmap1 BitmapTarget2D
        {
        ...
        /// </summary>
        internal event Action<D3DApplicationBase> OnSizeChanged;
    }
}
