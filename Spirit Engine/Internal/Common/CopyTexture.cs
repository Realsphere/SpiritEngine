...
{
    internal static class CopyTexture
    {
        internal static void CopyToTexture(DeviceContext context, Texture2D source, Texture2D destination, int subResource = 0)
        {
        ...
        internal static Guid PixelFormatFromFormat(SharpDX.DXGI.Format format)
        {
            switch (format)
            {
        ...
        internal static void SaveBitmap(DeviceManager dev, SharpDX.WIC.Bitmap bm, string filename)
        {
        ...
        internal static System.Drawing.Bitmap SaveToBitmap(DeviceManager deviceManager, Texture2D source)
        {
        ...
        internal static void SaveToFile(DeviceManager deviceManager, Texture2D source, string filename, SharpDX.DXGI.Format? format = null, int subResource = 0)
        {
        ...
        internal static SharpDX.WIC.Bitmap SaveToWICBitmap(DeviceManager deviceManager, Texture2D source)
        {
            var device = deviceManager.Direct3DDevice;
            var context = deviceManager.Direct3DContext;
