...
namespace Realsphere.Spirit.RenderingCommon
{
    ...
    /// </summary>
    internal class BezierMesh: IBinarySerializable
    {
        internal struct BezierHeader
        {
            internal int Header;
            ...
            /// </summary>
            internal int RegularPatchCount;
            /// <summary>
            /// The number of Tensor-product Gregory patches
            /// </summary>
            internal int QuadPatchCount;
            /// <summary>
            /// The number of triangular Gregory patches
            /// </summary>
            internal int TriPatchCount;
        }

        internal BezierHeader Header;

        // 16 per regular patch
        internal IReadOnlyCollection<Vector3> RegularBezierControlPoints { get { return _RegularBezierControlPoints.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector2> RegularTextureCoordinates { get { return _RegularTextureCoordinates.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector3> RegularNormals { get { return _RegularNormals.AsReadOnly(); } }

        // 32 per quad patch
        internal IReadOnlyCollection<Vector3> QuadBezierControlPoints { get { return _QuadBezierControlPoints.AsReadOnly(); } }
        // 20 per quad patch
        internal IReadOnlyCollection<Vector3> QuadGregoryControlPoints { get { return _QuadGregoryControlPoints.AsReadOnly(); } }
        // 24 per quad patch
        internal IReadOnlyCollection<Vector3> QuadPmControlPoints { get { return _QuadPmControlPoints.AsReadOnly(); } }
        // 16 per patch
        internal IReadOnlyCollection<Vector2> QuadTextureCoordinates { get { return _QuadTextureCoordinates.AsReadOnly(); } }
        // 16 per patch
        internal IReadOnlyCollection<Vector3> QuadNormals { get { return _QuadNormals.AsReadOnly(); } }

        internal IReadOnlyCollection<Vector3> TriGregoryControlPoints { get { return _TriGregoryControlPoints.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector3> TriPmControlPoints { get { return _TriPmControlPoints.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector2> TriTextureCoordinates { get { return _TriTextureCoordinates.AsReadOnly(); } }
        ...
        internal int FaceTopologyCount;
        internal int PrimitiveSize;

        // Length = FaceTopologyCount * 32 * PrimitiveSize
        internal IReadOnlyCollection<float> BezierStencil { get { return _BezierStencil.AsReadOnly(); } }

        // Length = FaceTopologyCount * 20 * PrimitiveSize
        internal IReadOnlyCollection<float> GregoryStencil { get { return _GregoryStencil.AsReadOnly(); } }

        internal IReadOnlyCollection<int> RegularFaceTopologyIndex { get { return _RegularFaceTopologyIndex.AsReadOnly(); } }
        internal IReadOnlyCollection<int> RegularVertexIndices { get { return _RegularVertexIndices.AsReadOnly(); } }
        internal IReadOnlyCollection<int> RegularStencilIndices { get { return _RegularStencilIndices.AsReadOnly(); } }
        internal IReadOnlyCollection<int> QuadFaceVertexCount { get { return _QuadFaceVertexCount.AsReadOnly(); } }
        internal IReadOnlyCollection<int> QuadFaceTopologyIndex { get { return _QuadFaceTopologyIndex.AsReadOnly(); } }
        internal IReadOnlyCollection<int> QuadVertexIndices { get { return _QuadVertexIndices.AsReadOnly(); } }
        internal IReadOnlyCollection<int> QuadStencilIndices { get { return _QuadStencilIndices.AsReadOnly(); } }

        internal IReadOnlyCollection<Vector3> Vertices { get { return _Vertices.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector3> Tangents { get { return _Tangents.AsReadOnly(); } }
        internal IReadOnlyCollection<int> Valences { get { return _Valences.AsReadOnly(); } }
        internal IReadOnlyCollection<Vector2> TextureCoordinates { get { return _TextureCoordinates.AsReadOnly(); } }
        internal int MaxValence;

        internal IReadOnlyCollection<int> RegularFaceIndices { get { return _RegularFaceIndices.AsReadOnly(); } }
        internal IReadOnlyCollection<int> QuadFaceIndices { get { return _QuadFaceIndices.AsReadOnly(); } }
        internal IReadOnlyCollection<int> TriFaceIndices { get { return _TriFaceIndices.AsReadOnly(); } }
        ...
        internal IReadOnlyCollection<int> InputMeshIndices { get { return _InputMeshIndices.AsReadOnly(); } }
        List<int> _InputMeshIndices;

        internal IReadOnlyCollection<int> Indices { get { return _Indices.AsReadOnly(); } }
        List<int> _Indices;

        internal Vector3 Center { get; private set; }

        internal void Serialize(BinaryWriter to)
        {
            throw new NotImplementedException();
        }

        internal void Deserialize(BinaryReader from)
        {
            // Bezier File Format :
        ...
        void IBinarySerializable.Serialize(BinaryWriter toStream)
        {
            Serialize(toStream);
        }

        void IBinarySerializable.Deserialize(BinaryReader fromStream)
        {
